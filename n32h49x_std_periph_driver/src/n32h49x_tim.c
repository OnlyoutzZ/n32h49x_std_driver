...
void TIM_DeInit(TIM_Module* TIMx)
{
    ...
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM1);
    } 
    else if (TIMx == GTIM2)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM2);
    }
    else if (TIMx == GTIM3)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM3);
    }
    else if (TIMx == GTIM4)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM4);
    }
    else if (TIMx == GTIM5)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM5);
    }
    else if (TIMx == GTIM6)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM6);
    }
    else if (TIMx == GTIM7)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_GTIM7);
    }
    else if (TIMx == GTIM8)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHEN_GTIM8);
    }
    else if (TIMx == GTIM9)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHEN_GTIM9);
    }
    else if (TIMx == GTIM10)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHEN_GTIM10);
    }
    else if (TIMx == BTIM1)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_BTIM1);
    }
    else if (TIMx == BTIM2)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_BTIM2);
    }    
    else
    {
...
*\*\          - Period
*\*\            * GTIM1 and GTIM4 range from 0x00000000 to 0xffffffff, but the others range from 0x0000 to 0xffff.
*\*\          - ClkDiv
*\*\            * TIM_CLK_DIV1
*\*\            * TIM_CLK_DIV2
*\*\            * TIM_CLK_DIV4
...
void TIM_ClrOcRefInputSource(TIM_Module* TIMx, uint32_t OCRefClearInputSelect,uint32_t OCRefClearInputSource)
{
    ...
    tmpctrl1 = TIMx->CTRL1;    
    tmpinsel = TIMx->INSEL;    
    /* Reset the CTRL1_CLRSEL\INSEL_ETRS bits */
    tmpctrl1 &= (uint32_t)(~TIM_CTRL1_CLRSEL);
    tmpinsel &= (uint32_t)(~TIM_INSEL_ETRS);  
    
    /* ETR select capture in */
    if (OCRefClearInputSelect == TIM_ETRSEL)
    {
...
*\*\return  none
**/
void TIM_SetCmp1(TIM_Module* TIMx, uint32_t Compare1)
{
    uint32_t tmpccdatx ;
    tmpccdatx = TIMx->CCDAT1 ;
    if (IS_GTIM1_4_DEVICE(TIMx))
    {
    ...
    else
    {
        /* Reset the Capture Compare1 Register value */ 
        tmpccdatx &= (uint32_t)(~TIM_CCDAT1_CCDAT1);
        tmpccdatx |= (uint16_t)Compare1;
        /* Set the Capture Compare1 Register value */
        TIMx->CCDAT1 = (uint16_t)tmpccdatx;
    }
}
...
*\*\return  none
**/
void TIM_SetCmp2(TIM_Module* TIMx, uint32_t Compare2)
{
    uint32_t tmpccdatx ;
    ...
    else
    {
        /* Reset the Capture Compare2 Register value */ 
        tmpccdatx &= (uint32_t)(~TIM_CCDAT2_CCDAT2);
        tmpccdatx |= (uint16_t)Compare2;
        /* Set the Capture Compare2 Register value */
        TIMx->CCDAT2 = (uint16_t)tmpccdatx;
    }
}
...
*\*\return  none
**/
void TIM_SetCmp3(TIM_Module* TIMx, uint32_t Compare3)
{
    uint32_t tmpccdatx ;
    ...
    else
    {
        /* Reset the Capture Compare3 Register value */ 
        tmpccdatx &= (uint32_t)(~TIM_CCDAT3_CCDAT3);
        tmpccdatx |= (uint16_t)Compare3;
        /* Set the Capture Compare3 Register value */
        TIMx->CCDAT3 = (uint16_t)tmpccdatx; 
    }        
}
...
*\*\return  none
**/
void TIM_SetCmp4(TIM_Module* TIMx, uint32_t Compare4)
{
    uint32_t tmpccdatx ;
    ...
    else
    {
        /* Reset the Capture Compare4 Register value */ 
        tmpccdatx &= (uint32_t)(~TIM_CCDAT4_CCDAT4);
        tmpccdatx |= (uint16_t)Compare4;
        /* Set the Capture Compare4 Register value */
        TIMx->CCDAT4 = (uint16_t)tmpccdatx; 
    }        
}
...
**/
uint32_t TIM_GetCap1(TIM_Module* TIMx)
{
    /* Get the Capture 1 Register value */
    if (IS_GTIM1_4_DEVICE(TIMx))
    {
        return (uint32_t)(TIMx->CCDAT1);
    }
    else
    {
...
**/
uint32_t TIM_GetCap2(TIM_Module* TIMx)
{
    /* Get the Capture 2 Register value */
    if (IS_GTIM1_4_DEVICE(TIMx))
    {
        return (uint32_t)(TIMx->CCDAT2);
    }
    else
    {
...
**/
uint32_t TIM_GetCap3(TIM_Module* TIMx)
{
    /* Get the Capture 3 Register value */
    if (IS_GTIM1_4_DEVICE(TIMx))
    {
        return (uint32_t)(TIMx->CCDAT3);
    }
    else
    {
...
**/
uint32_t TIM_GetCap4(TIM_Module* TIMx)
{
    /* Get the Capture 4 Register value */
    if (IS_GTIM1_4_DEVICE(TIMx))
    {
        return (uint32_t)(TIMx->CCDAT4);
    }
    else
    {
