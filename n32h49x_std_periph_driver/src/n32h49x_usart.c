...
void USART_DeInit(USART_Module* USARTx)
{
    if (USARTx == USART1)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_USART1);
    }
    else if (USARTx == USART2)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_USART2);
    }
    else if (USARTx == USART3)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_USART3);
    }
    else if (USARTx == USART4)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_USART4);
    }
    else if (USARTx == UART5)
    {
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_UART5);
    }
    else if (USARTx == UART6)
    {
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_UART6);
    }
    else if (USARTx == UART7)
    {
       RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_UART7);
    }
    else if (USARTx == UART8)
    {
       RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHEN_UART8);
    }
    else if (USARTx == USART9)
    {
       RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_USART9);
    }
    else
    {
        if (USARTx == UART10)
        {
            RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_UART10);
        }
    }
}
...
void USART_Init(USART_Module* USARTx, USART_InitType* USART_InitStruct)
{
    ...
    tmpregister &= USART_CTRL3_CLR_MASK;
