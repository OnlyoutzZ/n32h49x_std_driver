...
/* SPI registers Masks */
#define SPI_CTRL1_CLR_MASK  			((uint16_t)0xF9F7U)
...
void SPI_I2S_DeInit(const SPI_Module* SPIx)
{
    ...
    if (SPIx == SPI1)
    {
        ...
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_SPI1);
    }
    else if (SPIx == SPI2)
    {
        /* Enable SPI2 reset state */
        RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_SPI2);
    }
		 else if(SPIx == SPI3)
    {
				/* Enable SPI3 reset state */
				RCC_EnableAPB1PeriphReset(RCC_APB1_PERIPHRST_SPI3);
    }    
    else if (SPIx == SPI4)
    {
        /* Enable SPI4 reset state */
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_SPI4);
    }   
    else if (SPIx == SPI5)
    {
        /* Enable SPI5 reset state */
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_SPI5);
    }
    else if (SPIx == SPI6)
    {
        /* Enable SPI6 reset state */
        RCC_EnableAPB2PeriphReset(RCC_APB2_PERIPHRST_SPI6);
    }else{}    
}
