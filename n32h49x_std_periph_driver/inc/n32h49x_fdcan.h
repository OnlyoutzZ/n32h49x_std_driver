...
/**
 *\*\file n32h49x_fdcan.h
 *\*\author Nsing
 *\*\version v1.0.0
 *\*\copyright Copyright (c) 2025, Nsing Technologies Inc. All rights reserved.
 **/

#ifndef __N32H49X_FDCAN_H__
#define __N32H49X_FDCAN_H__
...
typedef struct
{
    ...
    uint32_t MsgRamStrAddr;             /* Specifies the Message RAM start address
                                            This parameter must be a value between 0x20000000 and 0x2008FFFF,
