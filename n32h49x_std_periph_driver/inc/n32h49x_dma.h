...
#ifndef __N32H49X_DMA_H__
#define __N32H49X_DMA_H__
...
typedef struct
{
    ...
    uint32_t BurstCmd;       /* Specifies the operation statue of the DMA BURST */
    
    uint32_t BurstMode;      /* Specifies the operation mode of the DMA BURST */
    
    uint32_t BurstLen;       /* Specifies the operation length of the DMA BURST */
...
#define DMA_BURST_ENABLE                ((uint32_t)DMA_REG_BIT_FIELD_MASK)
#define DMA_BURST_DISABLE               ((uint32_t)DMA_BURSTEN_BURST_BYPASS)

/** DMA burst len definition **/
#define  DMA_BURST_LEN_MASK             (~(uint32_t)DMA_CHCFG1_BURST_BLEN)
#define  DMA_BURST_LEN_SINGLE           ((uint32_t)DMA_REG_BIT_FIELD_MASK)
#define  DMA_BURST_LEN_1                ((uint32_t)DMA_CHCFG1_BURST_BLEN_0)
#define  DMA_BURST_LEN_2                ((uint32_t)DMA_CHCFG1_BURST_BLEN_1)
#define  DMA_BURST_LEN_3                ((uint32_t)(DMA_CHCFG1_BURST_BLEN_0 \
                                                  | DMA_CHCFG1_BURST_BLEN_1))
#define  DMA_BURST_LEN_4                ((uint32_t)DMA_CHCFG1_BURST_BLEN_2)
#define  DMA_BURST_LEN_5                ((uint32_t)(DMA_CHCFG1_BURST_BLEN_0 \
                                                  | DMA_CHCFG1_BURST_BLEN_2))
#define  DMA_BURST_LEN_6                ((uint32_t)(DMA_CHCFG1_BURST_BLEN_1 \
                                                  | DMA_CHCFG1_BURST_BLEN_2))
#define  DMA_BURST_LEN_7                ((uint32_t)(DMA_CHCFG1_BURST_BLEN_0 \
                                                  | DMA_CHCFG1_BURST_BLEN_1 \
                                                  | DMA_CHCFG1_BURST_BLEN_2))
#define  DMA_BURST_LEN_8                ((uint32_t)DMA_CHCFG1_BURST_BLEN)
...
#define DMA_REMAP_DSMU_FILT0   ((uint32_t)0x00000003U)
...
#define DMA_REMAP_RES          ((uint32_t)0x0000001CU)
#define DMA_REMAP_DSMU_FILT1   ((uint32_t)0x0000001DU)
...
#define DMA_REMAP_SDIO         ((uint32_t)0x0000002EU)
#define DMA_REMAP_DAC1         ((uint32_t)0x0000002FU)
#define DMA_REMAP_DAC2         ((uint32_t)0x00000030U)
#define DMA_REMAP_DSMU_FILT2   ((uint32_t)0x00000031U)
#define DMA_REMAP_DSMU_FILT3   ((uint32_t)0x00000032U)
#define DMA_REMAP_USART9_TX    ((uint32_t)0x00000033U)
#define DMA_REMAP_USART9_RX    ((uint32_t)0x00000034U)
#define DMA_REMAP_UART10_TX    ((uint32_t)0x00000035U)
#define DMA_REMAP_UART10_RX    ((uint32_t)0x00000036U)
